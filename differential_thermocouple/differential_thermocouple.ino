...
{
  // configure CH16 for diode, differential, 3 conversion cycles, average enabled, low excitation current
  unsigned char CH16_config[4] = {0b11100011, 0b00000000, 0b000000000, 0b00000000};

  // convert eta to binary (see LTC2983 datasheet, page 24)
  long eta_long = (eta * 1048576) / 1000;
  CH16_config[3] |= (char)eta_long;
  CH16_config[2] |= (char)(eta_long >> 8);
  CH16_config[1] |= (char)(eta_long >> 16);

  // write the register
  write_SPI(0x23c, 4, CH16_config);
}
...
void sensor_config()
{
  ...
  // configure all channels for K-type thermocouple, differential, OC check high current, cold-junction compensation from CH16
  const unsigned char sensor_config[] = {0b00010100, 0b00011100, 0b00000000, 0b00000000};
